document.getElementById("normal-xo").onclick = function () {
  document.getElementById("hello").textContent =
    "Welcome In Normal Tic-Tac-Toe";
...
class Normal_XO extends Board {
  constructor(x, y, gn, p1, p2) {
    ...
    document.getElementById("new-game").onclick = () => {
      new Normal_XO(3, 3, "Normal", p1, p2);
    };
    // Choosing PvP
    ...
    rulesList.innerHTML = `
            <li>It's a classic Tic-Tac-Toe game</li>
